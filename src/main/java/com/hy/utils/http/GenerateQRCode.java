...
public class GenerateQRCode {
	...
	private static BufferedImage scale(String srcImageFile, int height, int width, boolean hasFiller) throws IOException {
		...
		if (hasFiller) {// 补白
			...
			if (width == destImage.getWidth(null)) graphic.drawImage(destImage, 0, (height - destImage.getHeight(null)) / 2, destImage.getWidth(null), destImage.getHeight(null), Color.white, null);
			else graphic.drawImage(destImage, (width - destImage.getWidth(null)) / 2, 0, destImage.getWidth(null), destImage.getHeight(null), Color.white, null);
			graphic.dispose();
			destImage = image;
		}
	...
	public static void main(String[] args) {
		String strUrl = "http://t.im/?url=http://a.goujin.me";
		encode(getUrl(strUrl), 500, 500, "G:/照片/10寸时尚杂志册调整/fm.JPG", "D:\\2013-01.jpg");
	}
